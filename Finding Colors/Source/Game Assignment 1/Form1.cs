    ...
    public partial class Form1 : Form
    {
        ...
        private void flpGame_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (KichO.i==Ocabiet.i && KichO.j == Ocabiet.j)
            {
                ...
                //Nếu là lần cuối cùng khi chơi  
                //và số lần trong màn được đưa về 1
                if (Manlan == Man)
                {
                    Man++;
                    Manlan = 1;
                    if (Man > 7) Man = 7;// không được vượt quá level 7 
            ...
            else // Sai ô
            {
                ...
                if (Man != 1) 
                {
                    ...
                    if (time - 3 <= 0) //Không cho trừ time đến số âm. nếu là âm thì endgame xuất hiện
                    {
        ...
        private void ShowFormEndGame()
        {
            ...
            // them vong lap khi bat dau lai game
        ...
        {
            DialogResult dr = MessageBox.Show("Want to exit the game?", "Notification", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
